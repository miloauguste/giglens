...
public abstract interface OfferCaptureDao {
    ...
    @androidx.room.Query(value = "SELECT AVG(score) FROM (SELECT score FROM offer_captures WHERE score IS NOT NULL ORDER BY timestamp DESC LIMIT 30)")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object getAverageScore(@org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super java.lang.Double> $completion);
